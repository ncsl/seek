...
addpath(genpath('/media/ncsl/Public/_toolboxes/distinguishable_colors'))
addpath(genpath('/media/ncsl/Public/_toolboxes/Colormaps'))
addpath(genpath('/media/ncsl/Public/_toolboxes/roman_numerals'))
