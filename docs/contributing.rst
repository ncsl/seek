Contributing to neuroimg_pipeline
======================
...
ticket to the
`Bug Tracker <https://github.com/adam2392/neuroimg_pipeline/issues>`_. You are
...
-  Verify that your issue is not being currently addressed by other
   `issues <https://github.com/adam2392/neuroimg_pipeline/issues?q=>`_
   or `pull requests <https://github.com/adam2392/neuroimg_pipeline/pulls?q=>`_.
...
<https://github.com/adam2392/neuroimg_pipeline/issues>`__, please do your best to
...
- Please include your **operating system type and version number**, as well as
  your **Python and neuroimg_pipeline versions**. This information
  can be found by running the following code snippet::

    import platform; print(platform.platform())
    import sys; print("Python", sys.version)
    import neuroimg_pipeline; print("neuroimg_pipeline", neuroimg_pipeline.__version__)
...
The preferred workflow for contributing to neuroimg_pipeline is to fork the main
repository on GitHub, clone, and develop on a branch. Steps: 

1. Fork the `project repository <https://github.com/adam2392/neuroimg_pipeline>`__ by clicking
...
2. Clone your fork of the neuroimg_pipeline repo from your GitHub account to your
   local disk:

   .. code:: bash

      $ git clone git@github.com:YourLogin/neuroimg_pipeline.git
      $ cd neuroimg_pipeline
...
Uniformly formatted code makes it easier to share code ownership. neuroimg_pipeline
